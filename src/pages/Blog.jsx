        ...
        <div className="bg-[#c2661f27] min-h-screen">
            ...
            <header className="bg-[#fef8f8] shadow-md py-6 px-8 flex justify-between items-center">
                ...
                <nav className="flex space-x-20">
                    ...
                    <Link to="/about" className="text-gray-700 font-semibold hover:text-[#e3a2a2]">About</Link>
            ...
            <div className="max-w-5xl mx-auto px-6 py-16 text-gray-800">
                <h2 className="text-3xl font-bold text-center mb-6">Cẩm Nang Chăm Sóc Da Mặt</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            <h3 className="text-xl font-semibold">Chăm Sóc Da Mặt Đúng Cách</h3>
                            <p className="text-gray-600 mt-2">Những bước chăm sóc da cơ bản giúp bạn có làn da tươi trẻ mỗi ngày.</p>
                            <Link to="/blog/cham-soc-da" className="text-[#e3a2a2] font-semibold mt-4 inline-block">Đọc thêm →</Link>
                        </div>
                    </div>
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        <img src="/images/skincare2.png" alt="Dưỡng ẩm đúng cách" className="w-full h-48 object-cover" />
                        <div className="p-4">
                            <h3 className="text-xl font-semibold">Tầm Quan Trọng Của Dưỡng Ẩm</h3>
                            <p className="text-gray-600 mt-2">Dưỡng ẩm đúng cách giúp da khỏe mạnh và ngăn ngừa lão hóa.</p>
                            <Link to="/blog/duong-am" className="text-[#e3a2a2] font-semibold mt-4 inline-block">Đọc thêm →</Link>
                        </div>
                    </div>
                    <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                        <img src="/images/skincare3.png" alt="Chống nắng cho da" className="w-full h-48 object-cover" />
                        <div className="p-4">
                            <h3 className="text-xl font-semibold">Bí Quyết Chống Nắng</h3>
                            <p className="text-gray-600 mt-2">Cách bảo vệ làn da khỏi tác hại của ánh nắng mặt trời.</p>
                            <Link to="/blog/chong-nang" className="text-[#e3a2a2] font-semibold mt-4 inline-block">Đọc thêm →</Link>
                        </div>
                    </div>
            ...
            {/* Footer */}
            <footer className="bg-[#fef8f8] text-gray-700 py-10">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 px-6">
                    ...
                    <div>
                        ...
                        <ul className="mt-2 space-y-1">
                            <li><a href="#" className="hover:text-[#000000]">Our Story</a></li>
                            <li><a href="#" className="hover:text-[#000000]">Mission</a></li>
                            <li><a href="#" className="hover:text-[#000000]">Sustainability</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 className="text-lg font-bold">Support</h3>
                        <ul className="mt-2 space-y-1">
                            <li><a href="#" className="hover:text-[#000000]">Contact Us</a></li>
                            <li><a href="#" className="hover:text-[#000000]">FAQ</a></li>
                            <li><a href="#" className="hover:text-[#000000]">Shipping & Returns</a></li>
                        </ul>
                    </div>
                    <div>
